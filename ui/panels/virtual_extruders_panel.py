...
def draw_virtual_extruders_list(layout: UILayout, pg: PropertyGroup, list_id: str) -> None:
...
class SlicerPanel_2_VirtualExtruders(BasePanel):
    ...
    def draw(self, context):
        ...
        draw_virtual_extruders_list(layout, pg, "virtual_extruders")
