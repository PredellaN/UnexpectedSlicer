...
from . import PACKAGE, ADDON_FOLDER
...
select_confs_from_json(os.path.join(ADDON_FOLDER, 'experimental', 'exported_conf.json'))

# from .constants import PRINTERS
PRINTERS = dict_from_json(os.path.join(ADDON_FOLDER, 'experimental', 'tunneled_printers.json'))
